...
class Register(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            db.session.rollback()
            return {error: "There was a problem processing your request. Please ensure the provided information is correct and try again."}, 401
...
class Login(Resource):
    ...
    def post(self):
        ...
        try:
            current_session_user = Users.query.filter_by(username=username).first() 
        except Exception as error:
        ...
        if check_password_hash(current_user.password, password):
            ...
            for field in data_to_change:
                if field == "password":
                    ...
                    setattr(current_user, field, data_to_change[field])
